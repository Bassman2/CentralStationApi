...
public class CentralStationModel : IJsonOnDeserialized
{
    ...
    private static readonly string path = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "CentralStationDemo", "CentralStationModel.json");
